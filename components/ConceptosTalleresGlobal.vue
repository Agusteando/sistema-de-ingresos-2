    ...
    <section class="card manual-card">
      ...
      <div class="manual-fields">
        ...
        <label class="field">
          ...
          <select v-model="manualServiceKey" :disabled="loading || !manualConceptId">
...
<script setup>
import { LucideBuilding2, LucideCircleAlert, LucideGlobe2, LucideLink2, LucideLoaderCircle, LucidePlus, LucideRefreshCw, LucideSearch, LucideSparkles, LucideX } from 'lucide-vue-next'
