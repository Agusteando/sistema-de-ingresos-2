...
import { NuxtModule, ModuleDependencyMeta } from '@nuxt/schema'
  interface SharedRuntimeConfig {
   ...
   dbBridgeTimeoutMs: string,

   dbBridgeAgentId: string,

   dbBridgeAgentIdCookie: string,

   dbBridgeAutoMigrateOnStartup: string,
   ...
   controlEscolarMysqlPort: string,
   ...
   controlEscolarMysqlConnectionLimit: string,
   ...
   gcpAdminSubject: string,

   githubUsername: string,

   githubToken: string,

   externalSyncApiKey: string,

   auroraApiToken: string,

   studentPhotoBaseUrl: string,
