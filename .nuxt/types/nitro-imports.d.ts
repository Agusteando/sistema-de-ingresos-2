declare global {
  ...
  const adjustConceptoStock: typeof import('../../server/utils/conceptos-stock').adjustConceptoStock
  ...
  const assertStockAvailableForConcept: typeof import('../../server/utils/conceptos-stock').assertStockAvailableForConcept
  ...
  const canManageConceptosStock: typeof import('../../server/utils/conceptos-stock').canManageConceptosStock
  ...
  const enrichConceptosWithStock: typeof import('../../server/utils/conceptos-stock').enrichConceptosWithStock
  ...
  const finalizeStockReservation: typeof import('../../server/utils/conceptos-stock').finalizeStockReservation
  ...
  const readStockMovements: typeof import('../../server/utils/conceptos-stock').readStockMovements
  ...
  const releaseStockReservation: typeof import('../../server/utils/conceptos-stock').releaseStockReservation
  ...
  const requireConceptosStockAdmin: typeof import('../../server/utils/conceptos-stock').requireConceptosStockAdmin
  const reserveStockForPayment: typeof import('../../server/utils/conceptos-stock').reserveStockForPayment
  ...
  const restockConceptoStock: typeof import('../../server/utils/conceptos-stock').restockConceptoStock
  const restoreStockForCanceledPayment: typeof import('../../server/utils/conceptos-stock').restoreStockForCanceledPayment
  ...
  const saveStockSettings: typeof import('../../server/utils/conceptos-stock').saveStockSettings
  ...
  const stockMapByConceptId: typeof import('../../server/utils/conceptos-stock').stockMapByConceptId
  ...
  const syncCentralConceptosStockToBridge: typeof import('../../server/utils/conceptos-stock').syncCentralConceptosStockToBridge
  const syncCentralConceptosStockToBridgeBestEffort: typeof import('../../server/utils/conceptos-stock').syncCentralConceptosStockToBridgeBestEffort
...
declare global {
  ...
  // @ts-ignore
  export type { ConceptoStockStatus, StockSource, ConceptoStockSnapshot, StockReservation } from '../../server/utils/conceptos-stock'
  import('../../server/utils/conceptos-stock')
  // @ts-ignore
...
export { NO_ADEUDO_CONTROL_PLANTELES_COLUMN, getExternalUsersColumns, getExternalUsersDiagnostics, ensureExternalUsersTable, isExternalUsersAvailable, findExternalAuthUserByEmail, externalUserAccessMode, queryExternalUsers, findExternalUserByEmail, listExternalUsers, createExternalUser, updateExternalUser, bulkUpdateExternalUsers, hasExternalControlRole, noAdeudoControlUsersColumnExists, listExternalControlUsersForNoAdeudo, getNoAdeudoControlUserForPlantel, setNoAdeudoControlUserForPlantel, touchExternalUserLogin, deleteExternalUser } from 'C:/Users/hp/sistema-de-ingresos-2/server/utils/external-users';
