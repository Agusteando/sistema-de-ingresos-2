    ...
    const schemaPromise = (async () => {
      ...
      await runSafeQuery(`
        CREATE TABLE IF NOT EXISTS no_adeudo_deudor_cartas (
          ...
          INDEX idx_no_adeudo_mark_sent_at (sent_at)
        ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
      `)
      ...
      await runSafeQuery(`
        CREATE TABLE IF NOT EXISTS no_adeudo_cartas_envios (
          ...
          INDEX idx_no_adeudo_envios_scope (plantel, ciclo, sent_at),
          INDEX idx_no_adeudo_envios_matricula (matricula, sent_at),
          INDEX idx_no_adeudo_envios_sender (sent_by_email, sent_at)
        ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
      `)
