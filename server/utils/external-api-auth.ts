...
const collectExpectedTokens = () => {
  ...
  const candidates: Array<{ source: string, value: string }> = [
    ...
    { source: 'TALLERES_AURORA_API_TOKEN', value: normalizeToken(process.env.TALLERES_AURORA_API_TOKEN) },
  ...
  if (!expected.length) {
    throw createError({
      ...
      data: {
        ...
        acceptedEnvVars: ['AURORA_API_TOKEN', 'TALLERES_AURORA_API_TOKEN', 'HUSKY_PASS_AURORA_API_TOKEN', 'EXTERNAL_CONTROL_ESCOLAR_API_TOKEN']
      }
    })
  }
