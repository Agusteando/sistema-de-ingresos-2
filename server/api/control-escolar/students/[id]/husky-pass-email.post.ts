import { fetchControlEscolarExternalStudentProfile, resolveControlEscolarAuth } from '../../../../utils/control-escolar'
...
export default defineEventHandler(async (event) => {
  ...
  const student = await fetchControlEscolarExternalStudentProfile(auth.agentId, matricula)
