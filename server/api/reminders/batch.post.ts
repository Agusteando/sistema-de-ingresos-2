...
export default defineEventHandler(async (event) => {
  ...
  for (const dest of destinatarios) {
    ...
    const fullHtml = `
      <div style="font-family: 'Inter', sans-serif; color: #1F2937; max-width: 600px; margin: 0 auto; padding: 30px; border: 1px solid #E5E7EB; border-radius: 12px; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.05);">
        <div style="text-align: center; margin-bottom: 25px; border-bottom: 2px solid #4E844E; padding-bottom: 20px;">
          <h2 style="color: #4E844E; margin: 0; font-size: 18px; text-transform: uppercase; letter-spacing: 1px;">Aviso Institucional - Estado de Cuenta</h2>
        </div>
